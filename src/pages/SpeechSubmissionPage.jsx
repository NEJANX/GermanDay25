  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const submissionData = {
        ...
        competition: 'speech', // Set competition type
      ...
      alert.success('Your speech has been submitted successfully!');
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text text-transparent">
            Speech Competition Submission
          </h1>
          <p className="text-xl text-slate-300">
            Submit your German speech video
          </p>
        </div>
        ...
        <div className="backdrop-blur-md bg-slate-800/50 rounded-2xl p-8 border border-slate-700">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Speech Information */}
            <div>
              <label className="block text-sm font-medium mb-2">Speech Topic (in German) *</label>
              <input
                type="text"
                name="speechTopic"
                ...
                required
                className="w-full px-4 py-3 bg-slate-700/50 border border-slate-600 rounded-lg focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-all"
                placeholder="Enter your chosen speech topic"
              />
            </div>

            <div>
              <label className="block text-sm font-medium mb-2">Speech Summary (Optional)</label>
              <textarea
                name="description"
                ...
                rows={4}
                className="w-full px-4 py-3 bg-slate-700/50 border border-slate-600 rounded-lg focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-all"
                placeholder="Provide a brief summary of your speech content or key arguments (optional)..."
              />
            </div>
            ...
            {!isUploading && !isSubmitting && submitStatus !== 'success' && (
              <div>
                <label className="block text-sm font-medium mb-2">Upload Speech Video *</label>
                <div className="border-2 border-dashed border-slate-600 rounded-lg p-6 text-center">
                  ...
                  >
                    ...
                    <span className="text-lg font-medium mb-2">
                      {formData.file ? formData.file.name : 'Click to upload your speech video'}
                    </span>
                ...
                <div className="bg-slate-700/30 rounded-lg p-6 text-center">
                  <div className="flex items-center justify-center mb-4">
                    ...
                    <span className="text-lg font-medium">
                      {isUploading ? 'Uploading video...' : 'Submitting your speech...'}
                    </span>
                  </div>
                  {isUploading && (
            ...
            {submitStatus === 'success' && (
              <div className="bg-green-900/30 border border-green-700/50 rounded-lg p-6 text-center">
                ...
                <p className="text-green-200 mb-4">
                  Your speech has been uploaded successfully. Thank you for participating in Zeit für Deutschland '25!
                </p>
                <button
                  type="button"
            ...
            <div className="grid md:grid-cols-2 gap-6 text-sm">
              <div>
                ...
                <ul className="space-y-1 text-slate-300">
                  ...
                  <li>• Must be delivered without notes or scripts</li>
              ...
              <div>
                ...
                <ul className="space-y-1 text-slate-300">
                  ...
                  <li>• Select a topic from the provided list</li>
